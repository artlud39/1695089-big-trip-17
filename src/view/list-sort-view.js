...
const createNewTaskSortTemplate = () => (
  `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
    <div class="trip-sort__item  trip-sort__item--day">
      <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" checked data-sort-type="${SORT_TYPE.DEFAULT}">
...
export default class ListSortTemplateView extends AbstractView {
  get template() {
    return createNewTaskSortTemplate();
  }
